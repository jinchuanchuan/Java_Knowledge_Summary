...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SortTestHelper.testSort("com.jcc.algorichms.algLiuyubo.Charter03.MergeSortBottomUp.MergeSort", arr1);
        SortTestHelper.testSort("com.jcc.algorichms.algLiuyubo.Charter03.MergeSortBottomUp.MergeSortBU", arr2);
