package com.jcc.algorichms.wanzhuanLiuyubo.ch08_Recurion_and_Backstracking.part_06_Word_Search;
...
public class Solution {
    ...
    private boolean searchWord(char[][] board, String word, int index,
        ...
        if(index == word.length() - 1) // word.length -1 就是表示要找的最后一个字符，如果相等就判断字符是否相等
